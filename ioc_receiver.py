...
class ioc_receiver:
    """
    IOCReceiver.py is made up of six methods, three of which pull their respective IOCs 
    and three corresponding methods to format the pulled IOCs ready to upload to Splunk. 
    For example, one method will pull IP addresses, and another formats the IP addresses
    in a way Splunk Enterprise Security' Threat Intelligence Framework will accept.
    """
    def __init__(self):
        ...
        self.splunk_util = splunk_util.splunk_uploader()
    ...
    def format_hashes(self, hash_list):
        ...
        self.splunk_util.base64_encode(final_list=final_list)
